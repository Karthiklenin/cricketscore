...
function displayCurrentScore() {
    ...
    currentScoreElement.innerText = `Current Score: ${currentScore} Runs and ${wickets}
wickets`;
}
...
function endOver() {
    ...
    overScoreElement.innerText = `Team ${currentTeam}, Over ${currentOver}:
${currentOverScore} runs`;
    ...
    scoreDisplay.innerText = `Team ${currentTeam} Total Score: ${totalScore} runs, Wickets:
${wickets}`;
